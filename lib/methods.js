...
Meteor.methods({
  ...
  //select a box in the user board
    ...
    if(currentUserId == oldGame.mainGame.turn){
      ...
      if(currentUserId == oldGame.userId){
        ...
        settings = {
          ...
          'mainGame.lastSelection': {
            playerId: oldGame.userId,
            index: oldGame.mainGame.userBoard[index].number,
            timestamp: new Date()
          }
        };
        ...
        settings = {
           ...
           'mainGame.lastSelection': {
             playerId: oldGame.opponentId,
             index: oldGame.mainGame.opponentBoard[index].number,
             timestamp: new Date()
           }
        };
        return Games.update(gameId, {
